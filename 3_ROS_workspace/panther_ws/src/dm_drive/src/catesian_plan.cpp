...
int main(int argc, char** argv)
{
    ...
    // 重复执行单圈轨迹5次（确保连续性）
    // for(int circle = 0; circle < TOTAL_CIRCLES && ros::ok(); ++circle) {
        // ROS_INFO("going to the %d arc...", circle+1);
        ...
        // if(!safeExecute(move_group, circle_plan)) {
        //     ROS_ERROR("the %d arc stop!!", circle+1);
        //     break;
        // }
    // }
